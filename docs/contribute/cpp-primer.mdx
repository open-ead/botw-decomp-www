...
description: C++ implementation trivia useful for decomp and landing 6-fig jobs
...
This is easiest to understand with a simple example:
...
As you'd expect, Derived has Base at offset 0, and Derived's own data members are appended at the end of the Base struct.
